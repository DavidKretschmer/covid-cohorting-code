...
### Differences by share of high-risk in-classroom contacts ###
###############################################################
...
names_est <- c(
  ...
  "transmission_risk/2021-02-23___15-31-47_en_0.125",
  "transmission_risk/2021-02-23___15-33-21_en_0.125",
  "transmission_risk/2021-02-23___15-34-17_ge_0.125",
  "transmission_risk/2021-02-23___15-34-52_ge_0.125",
  "transmission_risk/2021-02-23___15-51-53_nl_0.125",
  "transmission_risk/2021-02-23___15-56-28_sw_0.125",
  "transmission_risk/2021-02-23___16-10-20_nl_0.125",
  "transmission_risk/2021-02-23___16-10-20_sw_0.125",

  "transmission_risk/2021-02-23___16-14-34_sw_0.5",
  "transmission_risk/2021-02-23___16-15-01_sw_0.5",
  "transmission_risk/2021-02-23___16-15-27_ge_0.5",
  "transmission_risk/2021-02-23___16-15-30_en_0.5",
  "transmission_risk/2021-02-23___16-23-30_en_0.5",
  "transmission_risk/2021-02-23___16-23-30_nl_0.5",
  "transmission_risk/2021-02-23___16-23-31_ge_0.5",
  "transmission_risk/2021-02-23___16-28-01_nl_0.5",
...
res_analysis <- res_complete %>%   
  mutate(
    ...
    share_high_risk = paste0("Proportion high-risk contacts: ", share_high_risk),
...
add_quarantine <- res_unclustered %>%
  ...
  group_by(share_high_risk, pr_out_of_school, mode, scenario, type, indicator) %>%
  summarize(
    mean_prob = .125,
    max_qua = max(value),
...
res_unclustered %>%
  ...
  facet_nested(indicator~share_high_risk + mode + scenario, scales = "free")


ggsave(filename = "Supp-D-Fig-1-Cohorting-Strategies-Risk.jpg", width = 18, height = 10)
...
### Share spread, share infected, share quarantined
...
#     axis.ticks.x = element_blank()
#   ) +
#   facet_nested(~share_high_risk + scenario, scales = "free")

# ggsave(filename = "Supp-D-Fig-0-Random-Cohorting-Risk..jpg", width = 12, height = 4)
